...
import DashRoot from '@/components/ui/BeginnerWordsQuizGrouped/BeginnerWordsQuizGrouped';
...
vi.mock('@/components/ui/BeginnerWordsQuiz/BeginnerWordsQuiz', () => ({
  default: () => <div data-testid="beginner-quiz">BeginnerWordsQuiz</div>,
}));
...
describe('DashRoot (BeginnerWordsQuizGrouped) component', () => {
