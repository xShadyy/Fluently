if (typeof window !== "undefined" && !window.matchMedia) {
  ...
  describe("DashRoot", () => {
    ...
    it("renders child components with default props (disableAnimation false)", () => {
      ...
      expect(screen.getByTestId("user-header")).toHaveTextContent("disableAnimation: false");
      expect(screen.getByTestId("sidemenu")).toHaveTextContent("disableAnimation: false");
    ...
    it("renders child components with disableAnimation true", () => {
      ...
      expect(screen.getByTestId("user-header")).toHaveTextContent("disableAnimation: true");
      expect(screen.getByTestId("sidemenu")).toHaveTextContent("disableAnimation: true");
      expect(screen.getByTestId("user-profile-data")).toBeInTheDocument();
    });
  });
